...
public class ThreeTahapEmpat extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.kasus_three_tahap_empat);
    ...
    public void next(View view) {
        Intent selesai = new Intent(getApplicationContext(), ThreeTahapEmpat_2.class);
        Intent i = getIntent();
