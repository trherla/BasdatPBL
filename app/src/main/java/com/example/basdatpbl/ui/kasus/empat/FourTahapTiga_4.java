...
public class FourTahapTiga_4 extends AppCompatActivity {

    TextView pertanyaan, judul;
    RadioGroup rg;
    RadioButton PilA, PilB;
    ImageView tabel_buku, imageA, imageB;
    ImageButton nxt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.kasus_four_tahap_tiga_4);
        ...
        if (tTiga.equalsIgnoreCase("Tabel Buku A")){
            tabel_buku.setImageResource(R.drawable.duanfa);
        }else {
            tabel_buku.setImageResource(R.drawable.duanfb);
        }
        imageA.setImageResource(R.drawable.tiganfa);
        imageB.setImageResource(R.drawable.tiganfb);
        pertanyaan.setText("Manakah dari kedua tabel ini yang sudah memenuhi bentuk normal ketiga(3NF)?");
        PilA.setText("Plihan A");
    ...
    public void next(View view) {
        ...
        Intent selesai = new Intent(getApplicationContext(), FourTahapEmpat.class);
//receive value from activity one and two
        ...
        selesai.putExtra("eTiga", ambil_jawaban_user);
